...
Promise.resolve(truncateResultsTable()).then(startApp()).then(startMockRailsApi()).then(startEchoServer).then(appendToNginxLog).then(getResultsCount).timeout(1000)['finally'](teardown).done();