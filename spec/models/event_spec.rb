...
RSpec.describe Event, type: :model do
  ...
  it "has many promoters" do
    promoter = Promoter.new(person: Person.create!)
    promoter_2 = Promoter.new(person: Person.create!)
  ...
  describe "#promoter_names" do
    ...
    it "returns promoter names" do
      event = Events::Create.new.do_it!
      event.promoters << Promoter.new(person: Person.create!(name: "David Hart"))
      event.promoters << Promoter.new(person: Person.create!(name: "David Saltzberg"))
